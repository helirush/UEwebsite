...
function App() {
  ...
  const setLaunchSession = useLaunchSessionStore((store) => store.setLaunchSession);
  const clearLaunchSession = useLaunchSessionStore((store) => store.clearLaunchSession);
