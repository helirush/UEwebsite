...
- **Consumption Total Cost:** $45.78 (Cost per hour)
...
- **Power Factor:** 0.839
- **Total Energy (Actual):** 103,740.52 kWh (19 days), 234.77 kW (per hour)
- **Total Energy (Monthly Equivalent):** 169,260.85 kWh
- **Total Waste (Actual):** 19,158.23 kWh (19 days), 43.36 kW (per hour)
...
- **Total Non-Active Field Burden (kVA - kW):** 43.36 kW/hr (actual)
- **Heat-Coupled Burden Used in Thermal Model:** 27.05 kW/hr (modeled_non_active_field_burden)
- **Monthly Equivalent Waste:** 70.74 kW/hr
- **Blended Electricity Rate:** $0.1950/kWh (all-inclusive)
- **PL2-2Center Utility Cost Offset (Monthly Equivalent):** $13.79/hour
- **Annual Offset Savings:** $74060/year

### Element 2: Cooling Elimination Savings

- **Total Heat No Longer Generated:** 97,440 BTU/hr
- **Total Cooling kW No Longer Needed:** 8.54 kW
- **Cooling Energy Cost Avoided:** $1.66/hour
- **Annual Cooling Savings:** $14580/year

### Element 3: CO2e Emissions Reduction Value

- **Total kW Waste Eliminated:** 51.89 kW
- **CO2e Emissions Avoided:** 169.69 metric tons/year
- **Monthly CO2e Reduction:** 14.14 metric tons/month
- **Hourly CO2e Reduction:** 0.0194 metric tons/hour
- **CO2e Value Rate:** $38/metric ton
- **Annual CO2e Value:** $6533/year
...
- **Max Reactive Energy:** 320.4 kVAR Max (Avg: 149.1 kVAR/hr ; 107,367 kVAR/mo)
- **Max Harmonic Distortion:** 30.2% Max (range: 3.0% - 30.2%)
- **Max Amperage:** 764A Max (range: 88A - 764A)
...
| ------ | ------- | --- | --- |
| Line to Neutral Voltage (277v) |   280.30 |   269.18 |   287.57 |
| Line to Line Voltage (480v) |   485.50 |   466.24 |   498.08 |
| Current (AMPS) |   331.75 |    88.34 |   763.71 |
| Phase Angle (degrees) |    32.88 |    24.63 |    42.18 |
...
- **Average kVA (Ssum_kVA):** 278.12 kVA
...
- **Calculated kVA (V×I×√3/1000):** 278.97 kVA

**Calculation Inputs:**
- Average Voltage (VIavg_V): 485.50 V
- Average Current (Iavg_A): 331.75 A
- Average kW (Psum_kW): 234.77 kW

### Differences (Measured vs Calculated)
- **kVA Difference:** 0.84 kVA (0.3%)
...
the measured kVA (278.12) and measured PF (0.839) values.
...
| ------ | ------- | ------------- | ------------------- | ------------- |
| kVA |   278.12 |        11.1% | 122,898.75 kVA | 801,065.27 TOTAL-HEAT |
| kW |   234.77 |         9.4% | 103,740.52 kWh | 124,875.09 Load-Heat |
| kVAR |   149.12 |         6.0% | 65,893.91 kVARh | - |
| WASTE |    43.36 |         1.7% | 19,158.23 WASTE | 23,061.25 Field-Heat |

### Heat Unit Notes

- **TOTAL-HEAT (BTU/hr):** 801,065.27
- **Load-Heat (BTU/hr):** 124,875.09
- **Field-Heat (BTU/hr):** 23,061.25
...
| ----- | ------- | ------ | -------- | ------ | ---------- |
| 3 |   278.12 |   234.77 |   148.75 |     0.84 |   11.1% |
...
| 01 |   307.31 |   260.07 |   163.43 |     0.85 |   12.3% |
| 02 |   304.87 |   258.45 |   161.44 |     0.85 |   12.2% |
...
| 08 |   307.58 |   259.94 |   164.13 |     0.85 |   12.3% |
