...
- **Consumption Total Cost:** $152.15 (Cost per hour)
...
- **Transformer:** Deli G
- **Power Factor:** 0.864
- **Total Energy (Actual):** 580,472.14 kWh (per period), 780.26 kW (per hour)
...
- **Max Reactive Energy:** 2,072.8 kVAR Max (Avg: 386.5 kVAR/hr ; 278,269 kVAR/mo)
- **Max Harmonic Distortion:** 28.4% Max (range: 3.0% - 28.4%)
- **Max Amperage:** 3,322A Max (range: 100A - 3322A)
...
| ------ | ------- | --- | --- |
| Line to Neutral Voltage (277v) |   277.54 |   263.55 |   289.65 |
| Line to Line Voltage (480v) |   480.71 |   456.48 |   501.69 |
| Current (AMPS) |  1049.31 |    99.60 |  3322.34 |
| Phase Angle (degrees) |    29.24 |     0.00 |    63.70 |
...
- **Average kVA (Ssum_kVA):** 870.73 kVA
...
- **Calculated kVA (V×I×√3/1000):** 873.68 kVA

**Calculation Inputs:**
- Average Voltage (VIavg_V): 480.71 V
- Average Current (Iavg_A): 1049.31 A
- Average kW (Psum_kW): 780.26 kW

### Differences (Measured vs Calculated)
- **kVA Difference:** 2.95 kVA (0.3%)
...
the measured kVA (870.73) and measured PF (0.864) values.
...
| ------ | ------- | ------------- | ------------------- | ------------- |
| kVA |   870.73 |        34.8% | 647,779.74 kVA | 2,662,347.42 TOTAL-HEAT |
| kW |   780.26 |        31.2% | 580,472.14 kWh | 276,631.39 Load-Heat |
| kVAR |   386.48 |        15.5% | 287,525.10 kVARh | - |
| WASTE |    90.47 |         3.6% | 67,307.60 WASTE | 32,076.29 Field-Heat |

### Heat Unit Notes

- **TOTAL-HEAT (BTU/hr):** 2,662,347.42
- **Load-Heat (BTU/hr):** 276,631.39
- **Field-Heat (BTU/hr):** 32,076.29
...
| ----- | ------- | ------ | -------- | ------ | ---------- |
| 7 |   870.73 |   780.26 |   373.05 |     0.90 |   34.8% |
...
| 17 | 1,056.64 |   963.77 |   423.47 |     0.91 |   42.3% |
