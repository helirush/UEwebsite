...
PATTERN_MATCHER = re.compile(r'^(?P<prefix>[a-z0-9][a-z0-9-]*)(?P<ptype>bt|b|s|v|m)\d*(?:_|$)', re.IGNORECASE)
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default='standard',
        help="Pass --verbosity to eeWILLIAM to control narration detail.",
    )
    parser.add_argument(
        '--packet-name',
